  ...
  return (
    <section id="models" className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        {/* Asymmetric bento grid: 2-col on md, 3-col on lg with different spans */}
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-12">
          {entries.map(([key, model], i) => {
            const isBest = key === bestKey;
            const isSelected = selected === key;

            // Bento layout: first card spans more cols
            const spanClass =
              i === 0
                ? "lg:col-span-5"
                : i === 1
            ...
            return (
              ...
              >
                ...
                <div className="mb-4 grid grid-cols-2 gap-3">
                  <div className="rounded-xl bg-sand-50/80 px-3.5 py-2.5">
